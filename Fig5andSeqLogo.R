...
for (i in 1:length(name)){
  ### dataset 16 from JA23020 is not used
  ...
  # "1 15 0.911768461491638"
  # "2 4 0.954216385014581"
  # "3 9 0.921674390601247"
  # "4 12 0.922576795481558"
  # "5 7 0.922879177377892"
  # "6 16 0.88887471145704"
  # "7 8 0.962121988723731"
  # "8 10 0.880373650917799"
  # "9 12 0.931572611427565"
  # "10 4 0.951273733750141"
  # "11 7 0.970193366176766"
  # "12 7 0.973162123203989"
  # "13 4 0.951423931604283"
  # "14 5 0.973442558449671"
  # "15 4 0.931690573239926"
  # "17 6 0.914565005729844"
  # "18 7 0.922107119123668"
  # "19 7 0.939336670174724"
  # "20 11 0.935360249400325"
  # "21 7 0.972915389236763"
  # "22 6 0.920922273259479"
  # "23 8 0.836397336752922"
  # "24 11 0.723534847592007"
  # "25 11 0.953967403438267"
  # "26 12 0.984900677460099"
  # "27 6 0.957299116533446"
  # "28 10 0.902933428584185"
  # "29 10 0.906633742658836"
  # "30 10 0.926054458088628"
  # "31 14 0.953060109289617"
  # "32 12 0.93034938194954"
...
write.xlsx(sheet, file = "snap_back.xlsx")
...
for (sample in 1:15){
  ...
  for (j in 1:dim(dat)[1]){
    dat$Nuc1[j]<-dat[j,(3+dat$Start[j])]
    dat$Nuc2[j]<-dat[j,(4+dat$Start[j])]
    dat$Nuc3[j]<-dat[j,(5+dat$Start[j])]
  }
  ...
  Nuc3<-data.frame(table(rep(dat$Nuc3,dat$Reads)))
  Nuc2<-data.frame(table(rep(dat$Nuc2,dat$Reads)))
  Nuc1<-data.frame(table(rep(dat$Nuc1,dat$Reads)))
